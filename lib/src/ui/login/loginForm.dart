...
import 'package:coupon_app/src/blocs/login/loginBloc.dart';

import 'createAccountButton.dart';
import 'googleLoginButton.dart';
              ...
              child: ListView(
                children: <Widget>[
                  Padding(
                    ...
                    child: Image.asset('lib/src/assets/images/escorpion-logo.png', height: 200),
                  ),
                  TextFormField(
